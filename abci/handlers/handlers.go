...
func CheckTx(ctx context.Context, tx *types.Transaction) abci.ResponseCheckTx {
...
func DeliverTx(ctx context.Context, tx *types.Transaction) abci.ResponseDeliverTx {
	t := reflect.TypeOf(tx.GetTx())
