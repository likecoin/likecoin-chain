...
func (m *Offer) GetExpiration() string {
	if m != nil {
		return m.Expiration
	}
	return ""
...
var fileDescriptor_7ab7f997be2cdae1 = []byte{
	...
	0x8b, 0xf4, 0x0a, 0x8a, 0xf2, 0x4b, 0xf2, 0x85, 0x04, 0xe1, 0xd2, 0x7a, 0x50, 0x69, 0xa5, 0x56,
	0x46, 0x2e, 0x56, 0x7f, 0x90, 0x12, 0x21, 0x49, 0x2e, 0x8e, 0xe4, 0x9c, 0xc4, 0xe2, 0xe2, 0xf8,
	0xcc, 0x14, 0x09, 0x46, 0x05, 0x46, 0x0d, 0xce, 0x20, 0x76, 0x30, 0xdf, 0x33, 0x45, 0x48, 0x94,
	0x8b, 0x2d, 0x2f, 0xad, 0x04, 0x24, 0xc1, 0x04, 0x96, 0x60, 0xcd, 0x4b, 0x2b, 0xf1, 0x4c, 0x11,
	0x12, 0xe1, 0x62, 0x4d, 0x2a, 0xad, 0x4c, 0x2d, 0x92, 0x60, 0x86, 0x88, 0x82, 0x39, 0x20, 0xd1,
	0x82, 0xa2, 0xcc, 0xe4, 0x54, 0x09, 0x16, 0x88, 0x28, 0x98, 0x23, 0x24, 0xc7, 0xc5, 0x95, 0x5a,
	0x51, 0x90, 0x59, 0x94, 0x58, 0x92, 0x99, 0x9f, 0x27, 0xc1, 0x0a, 0x96, 0x42, 0x12, 0x71, 0x72,
	...
	0xd2, 0x24, 0xbd, 0xe4, 0xfc, 0x5c, 0xb0, 0xa7, 0x92, 0xf3, 0xa1, 0xbe, 0x83, 0xf8, 0xb3, 0x02,
	0xee, 0xd3, 0x92, 0xca, 0x82, 0xd4, 0xe2, 0x24, 0x36, 0xb0, 0x57, 0x8d, 0x01, 0x01, 0x00, 0x00,
	0xff, 0xff, 0x3b, 0x2c, 0xca, 0xa3, 0x0b, 0x01, 0x00, 0x00,
}
...
func (m *Offer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Expiration) > 0 {
		...
		i = encodeVarintOffer(dAtA, i, uint64(len(m.Expiration)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Price) > 0 {
		i -= len(m.Price)
		copy(dAtA[i:], m.Price)
		i = encodeVarintOffer(dAtA, i, uint64(len(m.Price)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Buyer) > 0 {
