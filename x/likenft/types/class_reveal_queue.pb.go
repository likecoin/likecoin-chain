...
func (m *ClassRevealQueue) GetRevealTime() string {
	if m != nil {
		return m.RevealTime
	}
	return ""
...
var fileDescriptor_ca4ae5e06215be6f = []byte{
	...
	,
}
...
func (m *ClassRevealQueue) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RevealTime) > 0 {
		...
		i = encodeVarintClassRevealQueue(dAtA, i, uint64(len(m.RevealTime)))
		i--
		dAtA[i] = 0xa
	}
