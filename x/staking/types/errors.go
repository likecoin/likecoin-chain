...
func ErrInvalidApprover(codespace sdk.CodespaceType) sdk.Error {
	return sdk.NewError(codespace, CodeInvalidAddress, "approver address is invalid")
}

func ErrValidatorNotInWEhitelist(codespace sdk.CodespaceType) sdk.Error {
	return sdk.NewError(codespace, CodeInvalidValidator, "validator not in whitelist")
}
