...
type MsgSetValidatorWhitelist struct {
	Whitelist       []sdk.ValAddress `json:"whitelist"`
	ApproverAddress sdk.AccAddress   `json:"approver_address"`
}

func NewMsgSetValidatorWhitelist(whitelist []sdk.ValAddress, approverAddr sdk.AccAddress) MsgSetValidatorWhitelist {
...
func (msg MsgSetValidatorWhitelist) Type() string  { return "set_validator_whitelist" }
func (msg MsgSetValidatorWhitelist) GetSigners() []sdk.AccAddress {
	return []sdk.AccAddress{msg.ApproverAddress}
}
...
// quick validity check
func (msg MsgSetValidatorWhitelist) ValidateBasic() sdk.Error {
	if msg.ApproverAddress.Empty() {
