...
var (
	...
	KeyWhitelistApprover = []byte("WhitelistApprover")
)
...
type Params struct {
	...
	WhitelistApprover sdk.AccAddress `json:"whitelist_approver"` // address which can add validator address into whitelist
}

func NewParams(unbondingTime time.Duration, maxValidators, maxEntries uint16,
	bondDenom string, whitelistApprover sdk.AccAddress) Params {
	...
	return Params{
		...
		BondDenom:         bondDenom,
		WhitelistApprover: whitelistApprover,
	}
}
...
func (p *Params) ParamSetPairs() params.ParamSetPairs {
	return params.ParamSetPairs{
		...
		{KeyWhitelistApprover, &p.WhitelistApprover},
	}
}
...
func DefaultParams() Params {
	return NewParams(DefaultUnbondingTime, DefaultMaxValidators, DefaultMaxEntries, sdk.DefaultBondDenom, nil)
}
...
func (p Params) String() string {
  ...
  Max Entries:        %d
  Bonded Coin Denom:  %s
  Whitelist Approver: %s`, p.UnbondingTime,
		p.MaxValidators, p.MaxEntries, p.BondDenom, p.WhitelistApprover)
}
