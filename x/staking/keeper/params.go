...
// WhitelistApprover - Address for adding validator whitelist
func (k Keeper) WhitelistApprover(ctx sdk.Context) (res sdk.AccAddress) {
	k.paramstore.Get(ctx, types.KeyWhitelistApprover, &res)
	return
}
