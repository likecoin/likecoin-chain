...
func (m *TracingIdRecord) Reset()         { *m = TracingIdRecord{} }
func (m *TracingIdRecord) String() string { return proto.CompactTextString(m) }
func (*TracingIdRecord) ProtoMessage()    {}
func (*TracingIdRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_f257c949a7742486, []int{1}
}
func (m *TracingIdRecord) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TracingIdRecord) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TracingIdRecord.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TracingIdRecord) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TracingIdRecord.Merge(m, src)
}
func (m *TracingIdRecord) XXX_Size() int {
	return m.Size()
}
func (m *TracingIdRecord) XXX_DiscardUnknown() {
	xxx_messageInfo_TracingIdRecord.DiscardUnknown(m)
}

var xxx_messageInfo_TracingIdRecord proto.InternalMessageInfo

func (m *TracingIdRecord) GetOwnerAddressBytes() []byte {
	if m != nil {
...
func (m *TracingIdRecord) GetLatestVersion() uint64 {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*TracingIdRecord)(nil), "likechain.iscn.TracingIdRecord")
}
...
var fileDescriptor_f257c949a7742486 = []byte{
	...
	,
}
...
func (m *TracingIdRecord) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TracingIdRecord) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TracingIdRecord) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TracingIdRecord) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TracingIdRecord) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
